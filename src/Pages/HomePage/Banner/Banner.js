  ...
  <div className="hero-content  text-neutral-content">
    ...
    <p className="">NEW ARRIVALS</p>
      ...
      <button className="btn btn-outline">SHOP NOW</button>
                ...
                <div className='col-span-1'>
                <div className="hero min-h-full" style={{ backgroundImage: `url(${images2})`}}>
  <div className="hero-overlay bg-opacity-50"></div>
  <div className="hero-content  text-neutral-content">
    <div className="max-w-md  my-16">
    <p className="">BLACK FRIDAY</p>
      <h1 className="mb-5 text-3xl font-bold">DISCOUNT MASK</h1>
      <p className="mb-5">Accusamus et iusto odgnissimos ducimusblanditiis praesentium </p>
      <button className="btn btn-outline text-white">SHOP NOW</button>
                ...
                <div className='col-span-1'>
                <div className="hero min-h-full" style={{ backgroundImage: `url(${images3})`}}>
  <div className="hero-overlay bg-opacity-10"></div>
  <div className="hero-content  text-neutral-content">
    <div className="max-w-md text-black my-16">
